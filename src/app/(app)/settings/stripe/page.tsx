  ...
  return (
    <div className="page">
      <PageHeader
        ...
        title="Stripe"
        description="Create Stripe-hosted payment links without UnitPulse handling card details."
      />
      ...
      <section className="card mt-7 grid grid-cols-[1fr_0.8fr]">
        <div className="p-9">
          ...
          <p className="quiet mt-4 max-w-xl leading-7">
            UnitPulse creates one-use deposit and balance links. Stripe hosts checkout,
        ...
        <div className="border-l border-[var(--line)] bg-[var(--paper-deep)] p-9">
          <p className="eyebrow">UnitPulse can</p>
          ...
          <p className="eyebrow mt-9">UnitPulse cannot</p>
          <ul className="mt-6 space-y-4 text-sm leading-6">
